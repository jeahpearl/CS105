...
# Save Model Section
save_model_path = "C:/Users/jeahp/Desktop/ITD105/CaseStudy105/Models"

# Function to load data (cached)
@st.cache_data
def load_data():
    return pd.read_csv('C:\\Users\\jeahp\\Desktop\\ITD105\\CaseStudy105\\csv\\survey lung cancer.csv')
...
# Display file path
file_path = 'C:\\Users\\jeahp\\Desktop\\ITD105\\CaseStudy105\\csv\\survey lung cancer.csv'
    ...
    if st.button('Train Model'):
        ...
        if model is not None:
            ...
            # K-Fold Cross-Validation
                ...
                model.fit(X, y)  # Ensure model is fitted if using cross-validation without explicit fitting in cross_val_score
                accuracy = cv_scores.mean()
                log_loss_value = "Not Applicable"
                report_df = None  # K-Fold doesn't necessarily produce a single report
...
# Check if the model is fitted by looking for an attribute that is only available post-fitting
